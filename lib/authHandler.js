...
var resetPasswordHandler = function (req,res,next) {
  var email = req.body.email,
      ...
      mailToken = {
                    ...
                    text: 'Your reset token is ' + randomKeyHex             
                  }
...
var newPasswordPOST =function (req,res) {
  var email = req.body.email;
      ...
      req.db.get('SELECT * FROM passwordReset WHERE email=?', email, function (err,row) {
        ...
        if(hasBeenused || createdAt < createdAt + 1800 ) { //1800 seconds represents half an hour. Has it been longer than half an hour since this was created?
